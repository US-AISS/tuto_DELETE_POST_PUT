...
public class SongResourceTest {
	...
	public void testGetSong() {
		...
		assertEquals("The id of the song do not match", song1.getId(), s.getId());
		assertEquals("The title of the song do not match", song1.getTitle(), s.getTitle());
		assertEquals("The artist of the song do not match", song1.getArtist(), s.getArtist());
		assertEquals("The album of the song do not match", song1.getAlbum(), s.getAlbum());
		assertEquals("The year of the song do not match", song1.getYear(), s.getYear());
	...
	public void testAddSong() {
		...
		assertNotNull("Error when adding the playlist", song3);
